...
class PaymentController {
    ...
    static initiatePayment = asyncHandler(async (req, res, next) => {
        ...
        const data = {
            ...
            success_url: `${process.env.BACKEND_URL}/HTML/payment-success.html?tran_id=${encodeURIComponent(transactionId)}`,
            fail_url: `${process.env.BACKEND_URL}/HTML/payment-fail.html`,
            cancel_url: `${process.env.BACKEND_URL}/HTML/payment-cancel.html`,
